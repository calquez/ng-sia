...
import { Http, Headers, XHRBackend, Request, RequestOptions, RequestOptionsArgs, Response, URLSearchParams } from '@angular/http';
...
@Injectable()
export class AlimarketAuthHttpService extends Http {
